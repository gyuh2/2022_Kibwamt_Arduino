...
//========================================================
#include "WiFiEsp.h"
char ssid[] = "IBWAmentoring";  // your network SSID (name)
char pass[] = "kibwakibwa";  // your network password
...
IPAddress hostIp(172, 16, 111, 99);
//IPAddress hostIp(3, 39, 194, 213); 172.16.111.99
   ...
   if(timeout == 1){ //처음
    ...
    client.stop();
      ...
      do{
        ...
        if(i % 5000 == 0){ //시연 시 500cnt, if(i % 5000 == 0)
          //자동제어
